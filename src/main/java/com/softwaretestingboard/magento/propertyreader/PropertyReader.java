...
public class PropertyReader {
    ...
    */
    ...
    public String getProperty(String propertyName) {
        ...
        Properties prop = new Properties();   // properties java util
        FileInputStream inputStream = null;
        try {
            inputStream = new FileInputStream(System.getProperty("user.dir") + "/src/test/java/resources/propertiesfile/config.properties");  // copy path and infront write  /src/test/java
